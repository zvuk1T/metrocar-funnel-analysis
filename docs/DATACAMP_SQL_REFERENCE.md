...
This map contains the SQL learning paths currently most relevant to Metrocar.
It is a starting map, not an exhaustive catalog of everything DataCamp teaches.
...
Beginner, intermediate, and advanced SQL techniques may all be used when they
are genuinely DataCamp-learnable and Data can understand, explain, and
approximately reconstruct their use in Metrocar.
...
business question, grain, sources, filters, joins, calculations, assumptions,
and validation visible. A technique does not become unacceptable merely
because it is absent from this reference map.
